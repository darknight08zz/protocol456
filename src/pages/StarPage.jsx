...
export default function StarPage() {
    ...
    const shapeColor = '#FFD166'; // Star color (gold/yellow)
...
Examples:
  ...
  Output: 10`
    ...
    // ❌ NO openCompiler function — button removed
    ...
    return (
        <div style={{
            ...
            <p style={{ fontSize: '1.3rem', color: '#ddd', marginBottom: '2rem', maxWidth: '650px', lineHeight: 1.6 }}>
                You have chosen the Star. Brilliance lights your way.
            ...
            {selectedProblem && (
                <div style={{
                    ...
                    {/* ❌ COMPILER BUTTON REMOVED — as requested */}
                </div>
            )}
        </div>
    );
